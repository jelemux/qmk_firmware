...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
     ...
     KC_LALT, KC_LGUI, LY_MED,           ALT_GR,  KC_CAPS, KC_SPC, OSM_LSFT,   OSM_RSFT, KC_SPC , KC_CAPS, ALT_GR,           KC_MINS, KC_EQUAL,KC_GRAVE
    ),
    [_MEDIA] = LAYOUT(
     ...
     _______,  LY_GAM, LY_ADJ,           KC_MUTE, CUT    , COPY   , _______,    _______, PASTE  , KC_PGUP, KC_PGDN,          XXXXXXX, _______, LY_BASE
    ),
    [_GAMING] = LAYOUT(
     KC_GRV,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                                           KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
     KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                                           KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
     KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_4,                         KC_2,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_RSFT,
     KC_LCTL, KC_ESC,  LY_BASE,          KC_LGUI, KC_LALT, KC_SPC,  KC_3,         KC_1,  KC_SPC,  KC_RALT, KC_RGUI,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_ADJUST] = LAYOUT(
     ...
     XXXXXXX, XXXXXXX, LY_BASE,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, LY_BASE
    ),
};
