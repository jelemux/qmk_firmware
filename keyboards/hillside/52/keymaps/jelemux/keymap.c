...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
     ...
     KC_LALT, KC_LGUI, LY_MED,           KC_LBRC, KC_GRV,  KC_SPC, OSM_LSFT,   OSM_RSFT, KC_SPC , ALT_GR,  KC_RBRC,          KC_MINS, KC_EQL,  KC_BSLS
    ),
    [_MEDIA] = LAYOUT(
     ...
     _______, LY_GAM,  LY_ADJ,           KC_MUTE, CUT    , COPY   , _______,    _______, PASTE  , KC_PGUP, KC_PGDN,          _______, _______, LY_BASE
    ),
    [_GAMING] = LAYOUT(
